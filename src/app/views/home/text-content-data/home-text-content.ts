export const homeContext: { [x: string]: any } = {
  PL: {
    header: 'Domy i wyposażenie wnętrz',
    textBody: [
      `Animo Niezawodność, funkcjonalność, solidne wykonanie, terminowość i
      profesjonalizm – to cechy, które zdecydowanie wyróżniają naszą firmę na rynku.
      W asortymencie posiadamy produkty pochodzące wyłącznie od renomowanych i
      cenionych marek, które są gwarancją asortymentu wysokiej jakości. Oferujemy
      m.in. najlepszej klasy żaluzje, bramy garażowe, drzwi automatyczne lub
      wewnętrzne z montażem, a także okna aluminiowe i rolety zewnętrzne oraz
      wewnętrzne.`,
      `
    ...
    cardTitle: 'Zgłoś usterkę',
    cardBody: `Awaria drzwi automatycznych, zwykłych a może rolety się nie zamykają?
        Zajmujemy się naprawą, serwisem oraz doradztwem w zakresie drzwi
        automatycznych, bram garażowych, rolet oraz systemów oddymiania. Po
        zgłoszeniu usterki skontaktujemy się z Państwem w celu ustalenia
        możliwości spotkania.`,
    cardImgSrc: 'reakcja-24-ico.png',
    cardButton: 'Zgłoś usterkę',
  },
};
